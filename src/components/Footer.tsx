    ...
    <div className="container mx-auto px-4 py-12">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <a href="https://www.tiktok.com/@mohammad.minta16" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-primary-foreground/10 hover:bg-primary-foreground/20 flex items-center justify-center transition-all hover:scale-110" aria-label="TikTok">
              <TikTokIcon />
            </a>
          </div>
          <div className="mt-6">
      ...
      <div className="mt-12 pt-8 border-t border-primary-foreground/10">
        <div className="text-center text-primary-foreground/60 text-sm">
          <p>&copy; {currentYear} Mosquée Arrahman. Tous droits réservés.</p>
          <p className="mt-2">
