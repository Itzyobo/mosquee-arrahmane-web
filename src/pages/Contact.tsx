            ...
            <div className="space-y-8">
              ...
              <div className="glass-effect p-6 rounded-xl hover-lift">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <a href="tel:+33400000000" className="text-muted-foreground hover:text-primary transition-colors">+33 4 72 02 02 88 / +33 6 16 46 19 79</a>
                  </div>
                </div>
              </div>
              ...
              <div className="glass-effect p-6 rounded-xl">
                ...
                <div className="flex flex-wrap gap-4">
                  ...
                  <a href="https://www.tiktok.com/@mohammad.minta16" target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-full bg-primary/10 hover:bg-primary hover:text-primary-foreground flex items-center justify-center transition-all hover:scale-110" aria-label="TikTok">
                    <TikTokIcon />
                  </a>
                </div>
              </div>
